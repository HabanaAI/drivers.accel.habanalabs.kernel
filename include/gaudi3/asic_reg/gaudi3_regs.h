...
#include "nic_mac_glob_stat_tx2_regs.h"
#include "nic_mac_glob_stat_rx2_regs.h"
#include "h9_hif_regs.h"
#include "nic_mac_glob_stat_rx0_regs.h"
#include "nic_mac_glob_stat_tx0_regs.h"
#include "mac_pcs_pcs200_regs.h"
#include "nic_txb_regs.h"
...
#include "nic_mac_glob_stat_rsfec_stats_regs.h"
#include "nic_mac_glob_stat_rx3_regs.h"
...
#define TPC_CFG_AXUSER_HBW_OFFSET	(mmHD0_TPC0_CFG_AXUSER_HBW_BASE - mmHD0_TPC0_QM_DCCM_BASE)
#define TPC_QM_AXUSER_HBW_OFFSET	(mmHD0_TPC0_QM_AXUSER_HBW_BASE - mmHD0_TPC0_QM_DCCM_BASE)
...
#define ROT_AXUSER_HBW_OFFSET		(mmHD1_ROT0_ROT_AXUSER_HBW_BASE - \
						mmHD1_ROT0_QM_AXUSER_HBW_BASE)
/* Decoder */
#define HDCORE_DECODER_OFFSET		(mmHD0_VDEC1_CMD_BASE - mmHD0_VDEC0_CMD_BASE)
#define DEC_AXUSER_BRDG_CTRL_DEC_HBW_OFFSET	(mmHD0_VDEC0_BRDG_CTRL_AXUSER_DEC_HBW_BASE - \
...
#define DUP_P_ENG_OFFSET	(mmD0_SPDMA0_DUP_ENG_BASE - mmD0_SPDMA0_DUP_P_BASE)
...
#define EDMA_AXUSER_HBW_CTX_OFFSET	(mmHD1_SEDMA0_CH0_CTX_AXUSER_HBW_BASE - \
						mmHD1_SEDMA0_QM_AXUSER_HBW_BASE)
/* CSLICE */
