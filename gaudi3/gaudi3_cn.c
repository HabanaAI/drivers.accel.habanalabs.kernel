...
#define GAUDI3_RACKSCALE_COLL_LAG_SIZE			0x18
#define GAUDI3_RACKSCALE_SCALEOUT_COLL_LAG_SIZE		0x0
...
static void gaudi3_cn_set_cn_data(struct hl_device *hdev)
{
	...
	case HL_SERVER_GAUDI3_RACK_WHITEBOX:
		...
		gaudi3_aux_data->scale_out_coll_lag_size = GAUDI3_RACKSCALE_SCALEOUT_COLL_LAG_SIZE;
		break;
	default:
