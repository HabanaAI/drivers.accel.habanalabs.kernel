...
static u32 gaudi2_sim_get_pci_id(struct hl_device *hdev)
{
	...
	case ASIC_GAUDI2E_SIM:
		return PCI_IDS_GAUDI2E_SIMULATOR;
	case ASIC_GAUDI2_HL_288_SIM:
		return PCI_IDS_GAUDI2_HL_288_SIMULATOR;
	case ASIC_GAUDI2D_HL_288_SIM:
		return PCI_IDS_GAUDI2D_HL_288_SIMULATOR;
	case ASIC_GAUDI2E_HL_288_SIM:
		return PCI_IDS_GAUDI2E_HL_288_SIMULATOR;
	...
	case ASIC_GAUDI2E_SIM_ARC:
		return PCI_IDS_GAUDI2E_ARC_SIMULATOR;
	case ASIC_GAUDI2_HL_288_SIM_ARC:
		return PCI_IDS_GAUDI2_HL_288_ARC_SIMULATOR;
	case ASIC_GAUDI2D_HL_288_SIM_ARC:
		return PCI_IDS_GAUDI2D_HL_288_ARC_SIMULATOR;
	case ASIC_GAUDI2E_HL_288_SIM_ARC:
		return PCI_IDS_GAUDI2E_HL_288_ARC_SIMULATOR;
	default:
		return PCI_IDS_GAUDI2_SIMULATOR;
	}
}
...
static int gaudi2_sim_get_reg_pcie_addr(struct hl_device *hdev, u32 reg, u64 *pci_addr)
{
	return -EINVAL;
}
...
static const struct hl_asic_funcs gaudi2_sim_funcs = {
	...
	.get_reg_pcie_addr = gaudi2_sim_get_reg_pcie_addr,
