...
enum gaudi2_irq_num {
	...
	/* TODO: SW-177833 set GAUDI2_MSIX_ENTRIES to 128 and rename constant */
	GAUDI2_IRQ_NUM_RESERVED_LAST = (128 - GAUDI2_NUM_RESERVED_INTERRUPTS - 1),
	...
	GAUDI2_IRQ_NUM_UNEXPECTED_ERROR_OLD = 256,
