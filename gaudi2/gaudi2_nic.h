...
#define REQ_QPC_BASE_SIZE	((NIC_MAX_QP_NUM + 1) * sizeof(struct gaudi2_qpc_requester))
#define RES_QPC_BASE_SIZE	((NIC_MAX_QP_NUM + 1) * sizeof(struct gaudi2_qpc_responder))

#define TMR_BASE_SIZE \
		(TMR_FSM_SIZE * 2 + TMR_FREE_SIZE + TMR_FIFO_SIZE)
...
#define TXS_FIFO_SIZE		ALIGN((NIC_MAX_QP_NUM * 4 * 2) + DEVICE_CACHE_LINE_SIZE * \
					TXS_GRANULARITY, DEVICE_CACHE_LINE_SIZE)
