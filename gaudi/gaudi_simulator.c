...
static int gaudi_sim_start(struct hl_simulator_device *edev, int major,
			int minor, struct hl_device **hdev);
static void gaudi_sim_stop(struct hl_device *hdev);
