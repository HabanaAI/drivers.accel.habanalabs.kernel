...
#define _HAS_GEN_POOL_CHUNK_WITH_ATOMIC_LONG  
#define _HAS_ASSIGN_STR_ONE_ARG
#define _HAS_DRM_ACCEL_H
#define _HAS_DEVICE_WITH_CONST_CLASS 
#define _HAS_SCHED_CLOCK_H
#define _HAS_U64_TO_USERPTR
#define _HAS_DMA_POOL_ZALLOC
#define _HAS_KREF_READ
#define _HAS_DEVICE_ADD_GROUPS
#define _HAS_DEVICE_ADD_GROUP
#define _HAS_KVMALLOC_ARRAY
#define _HAS_KVCALLOC
#define _HAS_MMAP_READ_LOCK
#define _HAS_MMGRAB
#define _HAS_JIFFIES64_TO_MSEC
#define _HAS_GEN_POOL_DMA_ALLOC
#define _HAS_GEN_POOL_DMA_ALLOC_ALIGN
#define _HAS_GEN_POOL_FIRST_FIT_ALIGN
#define _HAS_GENPOOL_ALGO_T_WITH_START_ADDR
#define _HAS_KTIME_GET_RAW_NS
#define _HAS_BITFIELD_H
#define _HAS_DMA_MAP_SGTABLE
#define _HAS_DEVICE_IOMMU_MAPPED
#define _HAS_RANDOM_U32
#define _HAS_CHECK_ADD_OVERFLOW
#define _HAS_VM_FLAGS_SET
#define _HAS_XARRAY_LIB
#define _HAS_IRQ_AFFINITY_NEW_INTERFACE
#define _HAS_200G_KSETTINGS
#define _HAS_100G_PER_LANE_KSETTINGS
#define _HAS_ETH_HW_ADDR_SET
#define _HAS_ETHTOOL_PUTS
#define _HAS_GENPOOL_DATA_ALIGN_STRUCT
#define _HAS_STRSCPY
#define _HAS_PCI_CONFIGURE_EXTENDED_TAGS
#define _HAS_HWMON_DEVICE_REGISTER_WITH_INFO
#define _HAS_HWMON_HWMON_T_ENABLE
#define _HAS_HWMON_HWMON_MAX
#define _HAS_HWMON_HWMON_I_ENABLE
#define _HAS_CONST_BIN_ATTRIBUTE
#define _HAS_EVENTFD_SIGNAL_SINGLE_PARAM
...
#endif /* _HAS_CLASS_CREATE_WITH_MODULE */
...
#endif /* !_HAS_EVENTFD_SIGNAL_SINGLE_PARAM */
...
#ifndef _HAS_100G_PER_LANE_KSETTINGS
enum __ethtool_link_mode_bit_indices_100g_per_lane {
...
#ifndef _HAS_RDMA_DRIVER_HBL
#define RDMA_DRIVER_HBL	21
#endif
...
#ifndef _HAS_SYSFS_EMIT
__printf(2, 3)
int sysfs_emit(char *buf, const char *fmt, ...);
#endif /* !_HAS_SYSFS_EMIT */

#ifndef EXPORT_SYMBOL_NS_GPL
#define EXPORT_SYMBOL_NS_GPL(sym, ...) EXPORT_SYMBOL_GPL(sym)
#else
#undef EXPORT_SYMBOL_NS_GPL
#ifdef _HAS__EXPORT_SYMBOL_NS
#define EXPORT_SYMBOL_NS_GPL(sym, ns) __EXPORT_SYMBOL_NS(sym, "_gpl", ns)
#else
#ifdef  _HAS_EXPORT_SYMBOL_NS_GPL_LOWERCASE
#define EXPORT_SYMBOL_NS_GPL(sym, ns) __EXPORT_SYMBOL(sym, "_gpl", ns)
#else
#define EXPORT_SYMBOL_NS_GPL(sym, ns) __EXPORT_SYMBOL(sym, "GPL", ns)
#endif /* _HAS_EXPORT_SYMBOL_NS_GPL_LOWERCASE */
#endif /* __EXPORT_SYMBOL_NS */
#endif /* !EXPORT_SYMBOL_NS_GPL */

#ifndef EXPORT_SYMBOL_NS
#define EXPORT_SYMBOL_NS(sym, ...) EXPORT_SYMBOL(sym)
#endif /* !EXPORT_SYMBOL_NS */
...
#else
#define MODULE_IMPORT_NS(ns) MODULE_INFO(import_ns, ns)
#endif /* _HAS__EXPORT_SYMBOL_NS */
#endif /* !MODULE_IMPORT_NS */

#ifdef _HAS_CONST_BIN_ATTRIBUTE
#define compat_bin_attribute const struct bin_attribute
#define compat_bin_attribute_p const struct bin_attribute * const
#else
#define compat_bin_attribute struct bin_attribute
#define compat_bin_attribute_p struct bin_attribute *
#endif
